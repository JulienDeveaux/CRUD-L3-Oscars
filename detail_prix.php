		...
		if(is_numeric($_GET['id'])){
			...
			if(!empty($prix)){
				...
				if(!empty($ceremonie)){
				    ...
				    for($i = 0; $i < sizeof($ceremonie); $i++) {
                        ...
                        $lien .= '<li><a href="detail_ceremonie.php?id='
                            .$ceremonie[$i]->getid_ceremonie().'"><img width=70 height=70 alt="'
                            .$ceremonie[$i]->getnom_ceremonie().'" src="Illustrations/Ceremonie/'
                            .$ceremonie[$i]->getid_ceremonie().'.png"></a>'
                            .$ceremonie[$i]->getnom_ceremonie().' </li>';
                    }
				...
				for($i = 0; $i < sizeof($recipiendaire); $i++) {
				    ...
				    $lien .= '<li><a href="detail_recipiendaire.php?id='
                        .$recipiendaire[$i]->getid_recipiendaire().'"><img width=70 height=70 alt="'
                        .$recipiendaire[$i]->getnom_recipiendaire().'" src="Illustrations/Recipiendaire/'
                        .$recipiendaire[$i]->getid_recipiendaire().'.png"></a> '
                        .$recipiendaire[$i]->getnom_recipiendaire().' '
                        .$recipiendaire[$i]->getprenom_recipiendaire().'</li>';
                }
				$lien .= '</ul>';
				echo $lien;
			}
