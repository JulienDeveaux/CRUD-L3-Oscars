	...
	if(!empty($_GET['id'])){
		...
		if(is_numeric($_GET['id'])){
			...
			if(!empty($recipiendaire)){
				...
				echo '<img width=100 height=150 alt="'
                    .$recipiendaire->getid_recipiendaire().'" src="Illustrations/Recipiendaire/'
                    .$recipiendaire->getid_recipiendaire().'.png">';
				...
				if(!empty($ceremonie)){
					echo '<ul>';
					$lien = '';
					$lien .= '<li><a href="detail_ceremonie.php?id='
                        .$ceremonie->getid_ceremonie().'"><img width=70 height=70 alt="'
                        .$ceremonie->getnom_ceremonie().'" src="Illustrations/Ceremonie/'
                        .$ceremonie->getid_ceremonie().'.png"></a>'
                        .$ceremonie->getnom_ceremonie().' </li>';
					echo $lien;
					echo '</ul>';
				}
				...
				if($nomination->getgagnante_nomination() == true) {
					...
					if(!empty($prix)){
						echo '<ul>';
						$lien = '';
						$lien .= '<li><a href="detail_prix.php?id='
                            .$prix->getid_prix().'"><img width=70 height=70 alt="'
                            .$prix->getnom_prix().'" src="Illustrations/Prix/'
                            .$prix->getid_prix().'.png"></a>'
                            .$prix->getnom_prix().' </li>';
						echo $lien;
						echo '</ul>';
						...
						echo '<a href="detail_film.php?id='
                            .$film->getId_film().'"><img width=70 height=70 alt="'
                            .$film->getTitre_film().'" src="Illustrations/Film/'
                            .$film->getId_film().'.png"></a>';
